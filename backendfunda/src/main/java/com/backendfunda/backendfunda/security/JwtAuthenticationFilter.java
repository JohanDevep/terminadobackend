...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (StringUtils.hasText(token) && jwtGenerador.validarToken(token)) {
            ...
            String correo = jwtGenerador.obtenernombreDeJwt(token);
            ...
            UserDetails userDetails = customUsersDetailsService.loadUserByUsername(correo);
            ...
            if (userRoles.contains("USUARIO") || userRoles.contains("ADMIN") || userRoles.contains("INS")) {
